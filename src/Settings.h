...
//    SCALE_SIZE,
    ...
    INPUT_BEGIN_BEGIN,  INPUT_0_END,
    INPUT_1_BEGIN,      INPUT_1_END,
    INPUT_2_BEGIN,      INPUT_2_END,
    INPUT_3_BEGIN,      INPUT_3_END,
    INPUT_4_BEGIN,      INPUT_4_END,
    INPUT_5_BEGIN,      INPUT_END_END,
...
#define INPUT_EXPRESSION_OFFSET 1
